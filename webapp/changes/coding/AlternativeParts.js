sap.ui.define([
...
], function (JSONModel, Fragment, ValueState, Constants, NavigationHelper, ReuseConstants) {
	"use strict";
	 ...
	 * @param {object} oAlternativePartItem Alternative Parts data
	 * @return {string} sStatusText Status text
	 * @public
	 */
	...
	/**
	 * Event handle for Alternative Parts dialog close
	 */
	...
	/**
	 * Event handler for Central purchase Contract link press
	...
	/**
	 * Event handler for supplier link press
	 * @param {sap.ui.base.Event} oEvent press event 
	 */
	...
	/**
	 * Formatter method for table line status color based on respective flag
	 * @param {object} oAlternativePartItem row context object
	 * @returns {string} line status color
	 */
	...
	/**
	 * Formatter method for setting table line status text based on repective flag
	 * @param {object} oAlternativePartItem row context object
	...
	/**
	 * Formatter method for setting table line status tooltip text
	 * @param {object} oAlternativePartItem row context object
	 * @returns {string} status text
	 */
	...
	/**
	 * Helper method for getting resource bundle text based on key
	 * @param {string} sKey resource bundle key
	 * @param {object} oArgs resource bundle arguments
	 * @returns {string} resource bundle text based on key
	 */
