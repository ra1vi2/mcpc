sap.ui.define([
    ...
    var ReuseMessageBox = {
        ...
        loadDialog: function (oResponse) {
            ...
            var aData = JSON.parse(oResponse.responseText).error.innererror.errordetails;
            oResultModel.setData(aData);
            Fragment.load({
                id: "idMessageBoxFragment",
                name: "vwks.nlp.s2p.mm.pctrcentral.manage.changes.reuse.fragments.ReuseMessageBoxDialog",
                controller: this
